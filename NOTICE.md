...
| | |
|---|---|
| Source | Companion (`/home/danny/Development/ISyCo Git/Companion`, https://github.com/DannyBaanks/Companion) |
...
Shinji's animated GIFs exist in Danny's Companion checkout but are **not committed** there, so they were not copied; TamagotchIA uses Shinji's committed PNGs and animates them with CSS.
